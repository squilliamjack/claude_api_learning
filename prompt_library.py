...
Stores reusable prompt templates for three use cases: student feedback email,
lesson plan generator, and parent update email. Includes a load_prompt function
to retrieve prompts by use case and version.
"""
...
library_entry = [
    ...
    },
    {
        ...
        "v2": """
            ...
            student grade: 10;
            student class: high school geometry;
            session topic: basic trig functions;
            strengths: core algebra and arithmetic;
            struggles: implementation of trig functions;
            my name: John Smith;
            session date: 3/30/2026;
